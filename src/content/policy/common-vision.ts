...
/**
 * COMMON VISION — full policy text per locale.
...
Дадайце поўны тэкст агульнага бачання арганізацыі.`,
  ...
  en: `[HERE: Common Vision text in English]

Add the full common vision text for the organization.`,

  pl: `[TUTAJ: tekst „Wspólna wizja” po polsku]

Dodaj pełny tekst wspólnej wizji organizacji.`,
};
